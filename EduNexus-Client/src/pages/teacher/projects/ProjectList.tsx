    ...
    useEffect(() => {
        const fetchProjects = async () => {
            ...
            try {
                ...
                const response = await fetch('/api/teacher/projects', { // Assuming this endpoint lists projects for the logged-in teacher
    ...
    return (
        ...
        <Box p={8} bg={bgColor} minH="100vh">
            <Flex justify="space-between" align="center" mb={8}>
                ...
                <Button
                    as={RouterLink}
                    to="/teacher/create-project" // Link to your create project route
                    leftIcon={<AddIcon />}
                    colorScheme="purple"
                    variant="solid"
                >
                            ...
                            {projects.map((project, index) => (
                                <React.Fragment key={project._id}>
                                    ...
                                    >
                                        <ChakraLink
                                            as={RouterLink}
                                            to={`/teacher/projects/view/${project.project_name}`} // Link to the view page
                                            fontWeight="medium"
